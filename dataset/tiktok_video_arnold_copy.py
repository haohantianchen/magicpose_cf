...
def tiktok_video_arnold(**kwargs):
    train_data_path = "/raid/lurenjie/MagicDance/TikTok-v4/TikTok-v4-densepose/train_set"
    train_pose_path = "/raid/lurenjie/MagicDance/TikTok-v4/TikTok-v4-densepose/pose_map_train_set"
    return init_ds(train_data_path, train_pose_path, with_pose=True, **kwargs)


def tiktok_video_arnold_val(**kwargs):
    data_path = "/raid/lurenjie/MagicDance/TikTok-v4/TikTok-v4-densepose/val_set"
    pose_path = "/raid/lurenjie/MagicDance/TikTok-v4/TikTok-v4-densepose/pose_map_val_set"
